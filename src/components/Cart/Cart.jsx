          ...
          <div className="row justify-content-between">
            <div className="col-lg-8">
              <div className={`${style.select} row mb-3`}>
                <div
                  className={`${style.selectCol} col-12 d-flex align-items-center ms-2`}
                >
              ...
              <div className={`row ${style.picOne} mb-3`}>
                <div
                  className={`col-12 ${style.picOneCol} d-flex align-items-center ms-2`}
                >
                  ...
                  <div className="col-3 col-sm-3  ms-auto text-end d-flex justify-content-around align-items-center">
                    <button
                      style={{
                        width: "35px",
                        height: "35px",
            ...
            <div className="col-xxl-4 col-xl-4 col-lg-4 col-sm-12 col-12">
              <div className={`${style.summary} row mb-3`}>
                <div
                  className={`${style.summaryCol} col-12 col-xxl-12 col-xl-12 col-lg-12 ms-2`}
                >
                  <div className={`${style.sum}`}>
                    <h5>Shopping summary</h5>
                    <div className={`${style.price}`}>
                      <p>Total Price</p>
                      <p className={`${style.money}`}>Rp. 135.000</p>
                    </div>
